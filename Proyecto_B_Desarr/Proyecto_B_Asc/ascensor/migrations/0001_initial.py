# Generated by Django 2.0 on 2018-12-10 00:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecnico', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Técnicos asignados')),
            ],
        ),
        migrations.CreateModel(
            name='Orden',
            fields=[
                ...
                ('tecnico', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Técnico')),
            ],
        ),
    ]
